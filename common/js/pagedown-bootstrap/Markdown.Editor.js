    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
	    ...
	    buttonBar.style = "height: 35px;";
            ...
            var makeButton = function (id, title, icon, textOp, group) {
                ...
                button.style = "font-size: 13px; line-height: 18px; padding: 4px 10px;";
            ...
            if (helpOptions) {
                ...
                helpButton.style = "font-size: 13px; line-height: 18px; padding: 4px 10px;";
