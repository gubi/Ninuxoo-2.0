...
<form method="post" action="" id="settings_frm" onsubmit="return false;" role="form">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="checkbox">
				<label>
					<input type="checkbox" <?php print (($GLOBALS["general_settings"]["login"]["allow_user_registration"] == "true") ? "checked" : "") ?> id="allow_user_registration" name="allow_user_registration" tabindex="2" />
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="checkbox">
				<label>
					<input type="checkbox" <?php print (($GLOBALS["user_settings"]["User"]["use_editor_always"] == "true") ? "checked" : "") ?> id="allow_editor_always" name="allow_editor_always" tabindex="3" />
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<input type="text" class="input-lg" name="station_name" id="station_name" value="<?php print $GLOBALS["config"]["Meteo"]["station_name"]; ?>" style="width: 50%;" tabindex="4"/>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="number" class="input-lg" name="meteo_refresh" id="meteo_refresh" size="5" maxlength="7" min="0" step="10" value="<?php print ($GLOBALS["config"]["Meteo"]["refresh_interval"]); ?>" tabindex="6" />
			</div>
			<div class="form-group">
				<label for="meteo_owid">OpenWeather ID:</label>
				<input type="text" class="input-lg" name="meteo_owid" id="meteo_owid" value="<?php print $GLOBALS["config"]["Meteo"]["OpenWeatherID"]; ?>" tabindex="7"/>
			</div>
		</div>
	</div>
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="form-group">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php print (($GLOBALS["config"]["Meteo"]["show_ninux_nodes"] == "true") ? "checked" : "") ?> id="show_ninux_nodes" name="show_ninux_nodes" tabindex="8" />
			...
			<div class="form-group">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php print (($GLOBALS["config"]["Meteo"]["show_region_area"] == "true") ? "checked" : "") ?> id="show_region_area" name="show_region_area" tabindex="9" />
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<input type="text" class="input-lg" name="meteo_city" id="meteo_city" value="<?php print $GLOBALS["config"]["Meteo"]["station_city"]; ?>" tabindex="10" />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" class="input-lg" name="meteo_country" id="meteo_country" value="<?php print $GLOBALS["config"]["Meteo"]["station_country"]; ?>" tabindex="11"/>
			</div>
		</div>
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<input type="number" class="input-lg" name="meteo_lat" id="meteo_lat" value="<?php print $GLOBALS["config"]["Meteo"]["latitude"]; ?>" tabindex="12" />
			</div>
			<div class="form-group">
				<label for="meteo_lng">Longitudine:</label>
				<input type="number" class="input-lg" name="meteo_lng" id="meteo_lng" value="<?php print $GLOBALS["config"]["Meteo"]["longitude"]; ?>" tabindex="13" />
			</div>
		</div>
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<input type="number" class="input-lg" name="meteo_altitude_mt" id="meteo_altitude_mt" size="2" value="<?php print $GLOBALS["config"]["Meteo"]["altitude_mt"]; ?>" tabindex="14" />
			
				<label for="meteo_altitude_ft">piedi:</label>
				<input type="number" class="input-lg" name="meteo_altitude_ft" id="meteo_altitude_ft" size="4" value="<?php print $GLOBALS["config"]["Meteo"]["altitude_ft"]; ?>" tabindex="15" />
			</div>
			<div class="form-group">
