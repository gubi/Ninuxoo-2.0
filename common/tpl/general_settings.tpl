...
<form method="post" action="" id="settings_frm" onsubmit="return false;" role="form">
	...
	<div class="panel panel-default">
		<div class="panel-heading"><span class="lead text-primary"><span class="picol picol_server"></span>&nbsp;&nbsp;Questo <acronym title="Network Attached Storage">NAS</acronym> <a name="NAS" id="NAS"></a><small class="help-block">Impostazioni locali</small></span></div>
		<div class="panel-body">
			<div class="form-group">
				<label for="station_name">Nome:</label>
				<input type="text" class="input-lg" name="nas_name" id="nas_name" value="<?php print $GLOBALS["config"]["NAS"]["nas_name"]; ?>" autofocus size="30" maxlength="30" tabindex="5"/>
			</div>
			<div class="form-group">
				<label for="station_name">Descrizione:</label>
				<input type="text" class="input-lg" name="nas_description" id="nas_description" value="<?php print $GLOBALS["config"]["NAS"]["nas_description"]; ?>" style="width: 80%;" tabindex="10"/>
				<span class="help-block">La descrizione figurer&agrave; nell'head di ogni pagina e come voce aggiuntiva nella dichiarazione del <acronym title="Network Attached Storage">NAS</acronym> in rete</span>
			</div>
		</div>
		<div class="panel-body">
			<div class="form-group">
				<label for="station_name">Indirizzo:</label>
				<input type="text" class="input-lg" name="http_root" id="http_root" value="<?php print $GLOBALS["config"]["NAS"]["http_root"]; ?>" style="width: 60%;" placeholder="http://ninuxoo.ninux.org" tabindex="11"/>
				<span class="help-block">Inserire l'indirizzo del <acronym title="Network Attached Storage">NAS.</acronym><br />&Egrave; consigliabile celare il proprio ondirizzo IP con un <acronym title="Domain Name System">DNS</acronym> di tipo anycast (in genere <tt>http://ninuxoo.ninux.org</tt>)</span>
			</div>
		</div>
		<div class="panel-footer">
			<span class="info">NOTA: &egrave; possibile modificare altre impostazioni nell'<a href="./Admin/Config_editor" title="Vai all'editor">editor di configurazione degli script</a></span>.
		</div>
	</div>
	<div class="panel panel-default">
		<div class="panel-heading"><span class="lead text-primary"><span class="fa fa-clock-o"></span>&nbsp;&nbsp;Accesso al Sistema <a name="Accesso_al_Sistema" id="Accesso_al_Sistema"></a><small class="help-block">Impostazioni relative alle connessioni al sistema</small></span></div>
		<div class="panel-body">
			<div class="form-group">
				<div class="input-group">
					<label for="session_length">Durata generale di una sessione: </label>
					<input type="number" class="input-lg" size="5" maxlength="7" min="0" step="10" id="session_length" name="session_length" value="<?php print $GLOBALS["general_settings"]["login"]["session_length"]; ?>" tabindex="20" />
			...
			<div class="form-group">
				<div class="input-group">
					<div class="checkbox">
						<label>
							<input type="checkbox" <?php print (($GLOBALS["general_settings"]["login"]["allow_user_registration"] == "true") ? "checked" : ""); ?> id="allow_user_registration" name="allow_user_registration" tabindex="25" />
			...
			<div class="form-group">
				<div class="input-group">
					<div class="checkbox">
						<label>
							<input type="checkbox" <?php print (($GLOBALS["general_settings"]["login"]["allow_browser_save"] == "true") ? "checked" : ""); ?> id="allow_browser_save" name="allow_browser_save" tabindex="30" />
							Permetti ai browsers di salvare i dati di connessione (autocompletamento)
						</label>
					</div>
				</div>
			</div>
		...
		<div class="panel-body">
			<div class="tabbable tabs-left">
				<ul class="nav nav-tabs nav-stacked">
					<li class="active">
						<a href="#collapseBook" data-toggle="tab" class="btn btn-link" tabindex="35"><span class="fa fa-book"></span>&nbsp;&nbsp;File ebook</a>
					</li>
					<li>
						<a href="#collapseAudio" data-toggle="tab" class="btn btn-link" tabindex="40"><span class="fa fa-music"></span>&nbsp;&nbsp;File audio</a>
					</li>
					<li>
						<a href="#collapseVideo" data-toggle="tab" class="btn btn-link" tabindex="45"><span class="fa fa-film"></span>&nbsp;&nbsp;File video</a>
					</li>
				</ul>
				<div class="tab-content">
						...
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">
									<input type="radio" id="title_author_editor" name="data_scan_ebook" value="title_author_editor" tabindex="50" <?php print (($GLOBALS["general_settings"]["file data"]["scan_ebook_name_order"] == "title_author_editor") ? "checked" : ""); ?> />
								</span>
							...
							<div class="input-group">
								<span class="input-group-addon">
									<input type="radio" id="author_title_editor" name="data_scan_ebook" value="author_title_editor" tabindex="55" <?php print (($GLOBALS["general_settings"]["file data"]["scan_ebook_name_order"] == "author_title_editor") ? "checked" : ""); ?> />
								</span>
							...
							<div class="input-group">
								<span class="input-group-addon">
									<input type="radio" id="author_editor_title" name="data_scan_ebook" value="author_editor_title" tabindex="60" <?php print (($GLOBALS["general_settings"]["file data"]["scan_ebook_name_order"] == "author_editor_title") ? "checked" : ""); ?> />
								</span>
					...
					<div class="tab-pane panel-body fade in" id="collapseAudio">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">
									<input type="radio" id="no_track_artist_album" name="data_scan_audio" value="no_track_artist_album" tabindex="65" <?php print (($GLOBALS["general_settings"]["file data"]["scan_audio_name_order"] == "no_track_artist_album") ? "checked" : ""); ?> />
								</span>
							...
							<div class="input-group">
								<span class="input-group-addon">
									<input type="radio" id="artist_album_no_track" name="data_scan_audio" value="artist_album_no_track" tabindex="70" <?php print (($GLOBALS["general_settings"]["file data"]["scan_audio_name_order"] == "artist_album_no_track") ? "checked" : ""); ?> />
								</span>
							...
							<div class="input-group">
								<span class="input-group-addon">
									<input type="radio" id="artist_no_track_album" name="data_scan_audio" value="artist_no_track_album" tabindex="75" <?php print (($GLOBALS["general_settings"]["file data"]["scan_audio_name_order"] == "artist_no_track_album") ? "checked" : ""); ?> />
								</span>
					...
					<div class="tab-pane panel-body fade in" id="collapseVideo">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">
									<input type="radio" id="title_year_director" name="data_scan_video" value="title_year_director" tabindex="80" <?php print (($GLOBALS["general_settings"]["file data"]["scan_video_name_order"] == "title_year_director") ? "checked" : ""); ?> />
								</span>
							...
							<div class="input-group">
								<span class="input-group-addon">
									<input type="radio" id="year_title_director" name="data_scan_video" value="year_title_director" tabindex="85" <?php print (($GLOBALS["general_settings"]["file data"]["scan_video_name_order"] == "year_title_director") ? "checked" : ""); ?> />
								</span>
							...
							<div class="input-group">
								<span class="input-group-addon">
									<input type="radio" id="director_title_year" name="data_scan_video" value="director_title_year" tabindex="90" <?php print (($GLOBALS["general_settings"]["file data"]["scan_video_name_order"] == "director_title_year") ? "checked" : ""); ?> />
								</span>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<span class="lead text-primary">
				<button title="Abilita il caching" id="allow_caching" class="btn btn-default right" tabindex="95"><span class="fa fa-fw <?php print (($GLOBALS["general_settings"]["caching"]["allow_caching"] == "true") ? "fa-check-square-o" : "fa-square-o"); ?>"></span></button>
		...
		<div class="panel-body caching_active">
			<div class="checkbox">
				<label>
					<input type="checkbox" <?php print (($GLOBALS["general_settings"]["caching"]["save_semantic_data"] == "true") ? "checked" : ""); ?> id="save_semantic_data" name="save_semantic_data" tabindex="100" />
			...
			<div class="form-group">
				...
				<select style="width: 150px;" tabindex="105" name="semantic_caching_refresh" id="semantic_caching_refresh">
		...
		<div class="panel-body caching_active">
			<div class="checkbox">
				<label>
					<input type="checkbox" <?php print (($GLOBALS["general_settings"]["caching"]["save_audio_spectum"] == "true") ? "checked" : ""); ?> id="save_audio_spectum" name="save_audio_spectum" tabindex="110" />
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<input type="text" class="input-lg" name="station_name" id="station_name" value="<?php print $GLOBALS["config"]["Meteo"]["station_name"]; ?>" style="width: 50%;" tabindex="115"/>
			</div>
			<div class="form-group">
				<label for="station_active">Stato: </label>
				<select id="station_active" name="station_active" tabindex="115" style="width: 150px;">
			...
			<div class="form-group">
				...
				<input type="number" class="input-lg" name="meteo_refresh" id="meteo_refresh" size="5" maxlength="5" min="0" step="10" value="<?php print ($GLOBALS["config"]["Meteo"]["refresh_interval"]); ?>" tabindex="120" />
			</div>
			<div class="form-group">
				<label for="meteo_owid">OpenWeather ID:</label>
				<input type="text" class="input-lg" name="meteo_owid" id="meteo_owid" value="<?php print $GLOBALS["config"]["Meteo"]["OpenWeatherID"]; ?>" tabindex="125"/>
			</div>
		</div>
	</div>
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="form-group">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php print (($GLOBALS["config"]["Meteo"]["show_ninux_nodes"] == "true") ? "checked" : "") ?> id="show_ninux_nodes" name="show_ninux_nodes" tabindex="130" />
			...
			<div class="form-group">
				<div class="checkbox">
					<label>
						<input type="checkbox" <?php print (($GLOBALS["config"]["Meteo"]["show_region_area"] == "true") ? "checked" : "") ?> id="show_region_area" name="show_region_area" tabindex="135" />
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<input type="text" class="input-lg" name="meteo_city" id="meteo_city" value="<?php print $GLOBALS["config"]["Meteo"]["station_city"]; ?>" tabindex="140" />
			</div>
			<div class="form-group">
				<label for="meteo_region">Regione:</label>
				<select id="meteo_region" name="meteo_region" tabindex="145" style="width: 200px;">
					<?php
			...
			<div class="form-group">
				...
				<input type="text" class="input-lg" name="meteo_country" id="meteo_country" value="<?php print $GLOBALS["config"]["Meteo"]["station_country"]; ?>" tabindex="150"/>
			</div>
		</div>
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<input type="number" class="input-lg" name="meteo_lat" id="meteo_lat" value="<?php print $GLOBALS["config"]["Meteo"]["latitude"]; ?>" tabindex="155" />
			</div>
			<div class="form-group">
				<label for="meteo_lng">Longitudine:</label>
				<input type="number" class="input-lg" name="meteo_lng" id="meteo_lng" value="<?php print $GLOBALS["config"]["Meteo"]["longitude"]; ?>" tabindex="160" />
			</div>
		</div>
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<input type="number" class="input-lg" name="meteo_altitude_mt" id="meteo_altitude_mt" size="2" value="<?php print $GLOBALS["config"]["Meteo"]["altitude_mt"]; ?>" tabindex="165" />
			
				<label for="meteo_altitude_ft">piedi:</label>
				<input type="number" class="input-lg" name="meteo_altitude_ft" id="meteo_altitude_ft" size="4" value="<?php print $GLOBALS["config"]["Meteo"]["altitude_ft"]; ?>" tabindex="170" />
			</div>
			<div class="form-group">
				<label for="meteo_altitude_unit">Unit&agrave; di misura predefinita:</label>
				<select name="meteo_altitude_unit" id="meteo_altitude_unit" style="width: 100px;" tabindex="175">
	...
	<hr />
	<button class="btn btn-primary right" id="save_settings_btn" tabindex="180">Salva&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-ok"></button>
</form>